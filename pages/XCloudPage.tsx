  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-[#0a0a0a] text-white p-4">
      ...
      <div className="relative z-10 text-center max-w-2xl">
        ...
        <p className="max-w-xl mx-auto mt-4 text-base italic text-gray-300 md:text-lg">
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            onClick={() => navigate('/')}
            className="w-full sm:w-auto px-8 py-3 bg-gray-700 text-white font-semibold rounded-md hover:bg-gray-600 transition-colors"
          >
            Go Back
          </button>
        </div>
